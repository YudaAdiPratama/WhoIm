    ...
    Pausable
{
    ...
    /**
     * Override isApprovedForAll to whitelist user's Whoim proxy accounts to enable gas-free listings.
     */
    ...
    {
        // Whitelist Whoim proxy contracts for easy trading.
    ...
    /**
     * This is used instead of msg.sender as transactions won't be sent by the original token owner, but by Whoim.
     */
...
/**
 * @title AssetContract
 * AssetContract - A contract for easily creating non-fungible assets on Whoim.
 */
contract AssetContract is ERC1155Tradable {
    ...
    function WhoImVersion() public pure returns (string memory) {
        return "2.1.0";
    }
    ...
    /**
     * Compat for factory interfaces on WhoIm
 ...
 * WhoIm shared asset contract - A contract for easily creating custom assets on WhoIm
 */
